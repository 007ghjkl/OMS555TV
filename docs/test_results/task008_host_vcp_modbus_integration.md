...
| 实物标识 | `MB1136-F411RE-C04`；唯一设备编号不进入仓库 |
...
本记录未实现、未验证项包括实时监控 UI、TestEngine、报告系统、公共 Raw Frame/错误注入和真实 RS485 电气层。RS485 后来由 `TASK-002/009/010` 于 2026-09-04 独立验收，不改变本记录的 VCP/UART 范围。
