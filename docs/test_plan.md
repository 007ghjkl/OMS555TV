...
> 状态：开发中基线 0.4（已同步 TASK-009/010 真实 RS485 证据）
...
未实际运行的测试不得标记通过。TASK-003、TASK-005、TASK-008、TASK-009 和 TASK-010 只能按各自记录标记通过。当前短距离 RS485 结果不得外推为 8/24 小时稳定性、工业长线、隔离或 EMC 验证。
