...
> 状态：开发中基线 1.5（Host Phase 6 已完成真实 RS485 全量验收）
...
未实际运行的测试不得标记通过。TASK-003、TASK-005、TASK-008、TASK-009、TASK-010、TASK-011、TASK-012、TASK-013、TASK-014、TASK-015、TASK-016、TASK-017、TASK-018、TASK-019 和 TASK-020 只能按各自记录标记通过。TASK-019 的 Fake/虚拟时间结果与 TASK-020 的真实 RS485 20 条/10 分钟结果保持独立口径；TASK-016 的 8 条 Phase 5 基础用例也不能替代 Phase 6、半自动步骤或正式 HTML/PDF 报告。当前短距离 RS485 结果不得外推为 8/24 小时稳定性、工业长线、隔离或 EMC 验证。
